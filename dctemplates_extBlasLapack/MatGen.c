...
/*     ================================================================= */
/* Subroutine */ int gen57pt_(nx, ny, nz, a, indx, pointr, afun, bfun, cfun, 
	dfun, efun, ffun, gfun)
integer *nx, *ny, *nz;
doublereal *a;
integer *indx, *pointr;
/* Subroutine */ int (*afun) (), (*bfun) (), (*cfun) (), (*dfun) (), (*efun) (
	), (*ffun) (), (*gfun) ();
{
...
integer *ldw, *info;
{
    ...
    extern doublereal templates_dlaran_();
    static integer rho;
...
/* L20: */
	...
	i__2 = *nx;
	for (i = 1; i <= i__2; ++i) {
	    work[i + (rho + j - 1) * work_dim1] = templates_dlaran_(iseed) * 100;
/* L30: */
	}
/* L40: */
    }
