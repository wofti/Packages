...
/* WT: avoid -fcommon, non-extern structs are in WT_utils.c */
#include "EXTERNdef.c"
...
/*     =========================================================== */
/* Subroutine */ int WT_UNUSED_matsplit_(omega, b, work, ldw, method, flag_, method_len,
	 flag_len)
...
/*     =========================================================== */
/* Subroutine */ int WT_UNUSED_jacsplit_(n, a, lda, work, ldw, flag_, flag_len)
integer *n;
doublereal *a;
integer *lda;
doublereal *work;
...
/*     =========================================================== */
/* Subroutine */ int WT_UNUSED_sorsplit_(omega, n, a, lda, b, work, ldw, flag_,
	flag_len)
doublereal *omega;
integer *n;
doublereal *a;
