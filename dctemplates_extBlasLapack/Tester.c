...
/*     ================================================================ */
/* WT: I renamed this function so that we now use the one in getbreak.c 
       instead the one here. */
doublereal WT_UNUSED_getbreak_()
{
    /* System generated locals */
...
/* Main program alias */ int templatestester_ () { MAIN__ (); }
